...
const Contact = () => {
    return (
        <section id="contato" className="py-32 bg-[#2A2A2A] text-white relative overflow-hidden">
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    <span className="text-xs uppercase tracking-[0.4em] text-[#A67C6D] mb-4 block">Contato</span>
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-3 bg-[#F7F4F2] text-[#7D2335] px-10 py-4 uppercase tracking-[0.25em] text-sm font-bold hover:bg-white hover:scale-105 transition-all duration-300"
                    >
                ...
                <div className="mt-20 max-w-4xl mx-auto border-t border-gray-800 pt-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left mb-12">
                        ...
                        >
                            ...
                            <p className="text-gray-400 font-light text-lg">Bairro Agenor de Campos<br />Mongaguá - SP</p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                            ...
                            <p className="text-gray-400 font-light text-lg">Para todo o Brasil<br />via vídeo chamada</p>
                        </motion.div>
                    </div>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 text-sm uppercase tracking-widest text-gray-500"
                    >
